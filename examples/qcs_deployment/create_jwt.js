// This will attempt to create an IdP, then generate a JWT for that IdP for use with interactive_login.html
...
async function createJWT() {
    ...
    console.log(Math.floor(Date.now()/1000), 'Generated JWT properties:', parseJwt(seedToken));

    console.log(Math.floor(Date.now()/1000), 'Generated JWT:', seedToken,);
